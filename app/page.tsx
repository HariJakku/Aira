          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-on-scroll">
              ...
              <p
                ...
                style={{ color: "var(--aira-text)", opacity: 0.75 }}
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              <div
                key={i}
                className="card-premium p-7 h-full animate-on-scroll"
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed opacity-60 max-w-xs mt-3">
                Transforming celebrations into lasting memories through premium, personalised gifting
                experiences.
              </p>
            </div>
